package com.gmcc.testserial.sm;
...
//		byte[] sourceData = plainText.getBytes();
		...
		String plainText = "112233445566778899";
		byte[] sourceData = Util.hexStringToBytes(plainText);
		// 国密规范测试私钥
        String prik = "0325375DC0DB445F6490D812C094B5E169F09B0F3AAFC468CE3581A05A521D4D";
		...
		// 国密规范测试公钥
		String pubk = "6329F03955A907D155E3E5740FA15FE1454B40B7E99325B532C1F3F1B917E9BC03B9BCFEDC8B5D84351D0ECE43301552C5DD45FFDB18CA4F490F62D08CB5C3DD";
		String pubkS = new String(Base64.encode(Util.hexToByte(pubk)));
		System.out.println("pubkS: " + pubkS);
		System.out.println("");
		
		BigInteger r = new BigInteger("9D995D72EED21EF51759D85A5FDFF4C6B0E12302CF572BE3D4F0ACC24D987493", 16);
		BigInteger s = new BigInteger("BEFE590638B09E07F40547BC5F9E1DACE12EB32C3D621C2D84763C6AB85F556A", 16);
